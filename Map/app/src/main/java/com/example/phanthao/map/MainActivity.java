...
public class MainActivity extends AppCompatActivity implements OnMapReadyCallback,DirectionFinderListener {
    ...
    public void onMapReady(GoogleMap googleMap) {
        map = googleMap;
        //LatLng hcmus = new LatLng(10.762754, 106.681169);
       // map.addMarker(new MarkerOptions().position(hcmus).title("Khoa học tự nhiên"));
     //   map.moveCamera(CameraUpdateFactory.newLatLngZoom(hcmus, 17));
