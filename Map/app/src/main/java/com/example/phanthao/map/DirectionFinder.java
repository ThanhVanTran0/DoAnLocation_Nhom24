...
class DirectionFinder {
    ...
    public DirectionFinder(MainActivity listener, String origin, String destination) {
    ...
    private class DownloadData extends AsyncTask<String, Void, String> {
        ...
        private void parseJSon(String s) throws JSONException {
            ...
            for (int i = 0; i < jsonRoutes.length(); i++) {
                ...
                route.duration = new com.example.phanthao.map.Duration(jsonDuration.getString("text"), jsonDuration.getInt("value")); // lay thoi gian
